...
public class HoaDonRepository {
    ...
    public List<HoaDon> getAll() {
        String query = "SELECT dbo.HoaDon.Id, dbo.HoaDon.IdAcc, dbo.Account.ChucVu, dbo.Account.HoTen, dbo.HoaDon.IdKH, dbo.KhachHang.HoTen AS Expr1, dbo.KhachHang.SDT, dbo.KhachHang.Email, dbo.HoaDon.IdTT, dbo.HoaDon.Ten, dbo.HoaDon.NgayTao, \n"
        ...
        try ( Connection con = SQLServerConnection.getConnection();  PreparedStatement ps = con.prepareStatement(query)) {
            ...
            while (rs.next()) {
                Account account = new Account(rs.getString(2), rs.getShort(3), rs.getString(4));
