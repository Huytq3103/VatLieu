...
public class DSTaiKhoan extends javax.swing.JPanel {
    ...
    public DSTaiKhoan() {
        ...
        String[] header = {"STT", "Họ tên", "Giới tính", "Người tạo", "Ngày tạo", "Trạng thái"};
        dtm.setColumnIdentifiers(header);
        listAccount = vas.getAll();
        showDataTbale(listAccount);
    }
    ...
    private void lbNextMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbNextMouseClicked
        // TODO add your handling code here:
        if (tbHienThi.getSelectedRow() > -1 && tbHienThi.getSelectedRow() < listAccount.size()) {
            int row = tbHienThi.getSelectedRow();
            tbHienThi.setRowSelectionInterval(row + 1, row + 1);
        }
    }//GEN-LAST:event_lbNextMouseClicked

    private void showDataTbale(List<Account> list) {
        dtm.setRowCount(0);
        int i = 1;
        for (Account account : list) {
            dtm.addRow(account.toDataRow(i));
            i++;
        }
    }
